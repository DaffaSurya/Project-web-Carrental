    ...
    return (
        <div className="div-footer">
           <div className="container-footer">
             ...
             <div className="content-footer">
             <p className="p-footer">Connect with us</p>
             <div className="footer-content">
                ...
                <div className="logo-footer">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="white" class="bi bi-twitch" viewBox="0 0 16 16">
             ...
             <div className="content-footer">
              <p className="p-footer">Copyright Binar 2022</p>
              <p className="blue-div">Binar</p>
             </div>
           </div>
        </div>
    );
